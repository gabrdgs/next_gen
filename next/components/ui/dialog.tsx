...
// ✅ Corrigido: Portal não recebe className
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 text-neutral-500 hover:text-neutral-700 transition">
        <X className="h-5 w-5" />
...
const DialogHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn("mb-4 flex flex-col space-y-1 text-center", className)} {...props} />
);
